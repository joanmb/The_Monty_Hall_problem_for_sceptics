...
In order to convince those who don't believe the solution, let's to simulate the game one million times. In all of them we are going to choose door $A$ and we are going to always decide to change the door. Let's count how many times we win the game.
